...
const ProdutosNaoMapeados: React.FC = () => {
  const [unmappedNameProducts, setUnmappedNameProducts] = useState<UnmappedProductSummary[]>([]);
  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-6">
        ...
        Considere mapeá-los na página "Mapeamento de Produtos" e "Carga de Dados" (aba Conversões) para uma análise mais consistente.
      </p>
